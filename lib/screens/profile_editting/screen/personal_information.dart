...
//                 Text(
//                   title,
//                   style: TobetoTextStyle.poppins(context).headlinePurpleBold20,
//                 ),
//                 const Spacer(),
//                 if (icon != null)
//                   IconButton(
...
//   Widget build(BuildContext context) {
//     return AlertDialog(
//       title: const Text('Yeni Yeteneği Ekle'),
//       content: TextField(
//         decoration: InputDecoration(
//           border: const OutlineInputBorder(),
//           hintText: 'Yeni yeteneği buraya girin',
//         ),
//       ),
//       actions: [
//         TextButton(
...
//         ElevatedButton(
//           onPressed: () {
//             // Yeni yeteneği kaydetme işlemleri burada yapılabilir.
//             Navigator.of(context).pop();
//           },
