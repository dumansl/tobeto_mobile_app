...
abstract class TobetoText {
  ...
  static String passwordResetBoxText = "Şifre sıfırlama linki için e-posta adresinizi giriniz.";
  // main page
  ...
  static String mainHeadline2 = "Ücretsiz eğitimlerle, geleceğin mesleklerinde sen de yerini al.";
  static String mainHeadline3 = "Aradığın “İş” Burada!";
  static String mainCard1 = "Başvurularım";
  static String mainCard2 = "Değerlendir";
  static String mainCard3 = "Duyuru ve Haberlerim";
  ...
  static String profileProjectAwards = "Proje & Ödüller";
  ...
  static String profileEditUnivercity = "Üniversite*";
  ...
  static String profileEditStartUnivercityDate = "Başlangıç Yılı*";
  static String profileEditStartUnivercityDateBox = "gg.aa.yyyy";
  static String profileEditGraduateUnivercityDate = "Mezuniyet Yılı*";
  ...
  static String profileEditCommunitySubtitle = "Henüz eklediğiniz bir kulüp veya topluluk bulunmamaktadır.";
  ...
  static String evaluationHeadline1 = "Yetkinliklerini ücretsiz ölç, bilgilerini test et.";
  static String evaluationCard1Title = "Tobeto İşte Başarı Modeli";
  static String evaluationCard1Body = "80 soru ile yetkinliklerini ölç, önerilen eğitimleri tamamla, rozetini kazan.";
  ...
  static String evaluationHeadline2 = "Aboneliğe özel değerlendirme araçları için";
  ...
  static String istanbulCard4Body =
