...
abstract class TobetoText {
  TobetoText._();
  //bottomAppbar
  static String bottomIconProfile = "Profilim";
  ...
  static String loginAlternative = "Veya ile Giriş Yapın";
  static String loginGuestButton = "Misafir Olarak Devam Et";
  ...
  static String loginLoginError = "Giriş yaparken bir hata oluştu! Lütfen tekrar deneyin.";
  static String loginValidatorEmail = "E-posta adresinizi giriniz";
  static String loginValidatorPassword = "Şifrenizi giriniz";
  static String loginStudent = "Öğrenci";
  static String loginEducator = "Eğitmen";
  static String loginForgotPasswordSuccess = "Şifre sıfırlama e-postası gönderildi. Lütfen emailinizi kontrol edin.";
  static String loginForgotPasswordError = "Kayıt olurken yaparken bir hata oluştu! Lütfen tekrar deneyin.";
  static String registerError = "Kayıt olurken yaparken bir hata oluştu! Lütfen tekrar deneyin.";
  static String registerValidatorName = "Lütfen adınızı girin";
  static String registerValidatorSurname = "Lütfen soyadınızı girin";
  static String registerValidatorEmail = "Lütfen e-posta adresinizi girin";
  static String registerValidatorEmailV2 = "Geçerli bir e-posta adresi girin";
  static String registerValidatorPassword = "Lütfen bir şifre girin";
  static String registerValidatorPasswordV2 = "Şifreniz en az 6 karakter olmalıdır";
  static String registerValidatorConfirmPassword = "Lütfen şifrenizi tekrar girin";
  static String registerConfirmPasswordError = "Parolalar uyuşmuyor";
  // signup page
  static String signUpName = "Ad";
  static String signUpSurname = "Soyad";
  static String signUpEmail = "E-posta";
  ...
  static String mainCard5 = "İş Süreçlerim";
  static String mainSearch = "Arama";
  static String mainEducation = "Tüm Eğitimlerim";
  static String mainContinue = "Devam Ettiklerim";
  ...
  static String profileBirthday = "DoğumTarihi";
  static String profileEmail = "E-Posta Adresi";
  static String profilePhoneNumber = "Telefon Numarası";
  static String profileGender = "Cinsiyet";
  ...
  static String profileProjectAwards = "Projeler ve Ödüller";
  static String profileWorkExperiences = "Profesyonel İş Deneyimi";
  static String profileInternship = "Staj & Gönüllü Çalışma Deneyimi";
  static String profileCommunity = "Üye Olunan Topluluklar";
  static String profileEducations = "Eğitim Hayatım";
  static String profileTobetoWorkSuccess = "Tobeto İşte Başarı Modelim";
  ...
  static String profileEditAppBar = "Profilimi Düzenle";
  static String profileEditName = "Adınız*";
  static String profileEditNameBox = "Lütfen adınızı giriniz...";
  ...
  static String profileEditCityBox = "Lütfen il seçiniz...";
  static String profileEditDistrict = "İlçe*";
  static String profileEditDistrictBox = "Lütfen ilçe seçiniz...";
  static String profileEditStreet = "Mahalle / Sokak*";
  static String profileEditStreetBox = "Lütfen adresinizi giriniz...";
  static String profileEditAboutMe = "Hakkımda*";
  ...
  static String profileEditWorkplaceLocation = "Şehir*";
  ...
  static String emptyLanguage = "Henüz eklediğiniz bir dil bulunmamaktadır.";
  static String profileEditLanguageNameBox = "Lütfen yabancı dil seçiniz...*";
  static String profileEditLanguageLevel = "Yabancı Dil Seviyesi*";
  static List<String> languageLevel = [
    'Temel Seviye (A1,A2)',
    'Orta Seviye (B1,B2)',
    'İleri Seviye (C1,C2)',
    'Anadil',
  ...
  static String successExamResultDescription2Content =
      "Tobeto ‘İşte Başarı Modeli’nin son yetkinliği yeni dünya ile ilgilidir. Bu yetkinlik, diğer yedi yetkinlikten farklı olarak, yeni dünya ile ilgili farkındalık yaratmak ve herkesin kendisini olabildiğince buna hazırlaması konusunda yönlendirici olması için modele eklenmiştir. Zira içinde bulunduğumuz zamanlar önemli bir geçiş sürecine işaret etmektedir. Dijital teknolojilerle birlikte yaşanan dönüşümler hayatın her alanını yeninden şekillendirmektedir. İş dünyası ve şirketler de bu dönüşümün hem lokomotifi hem de etkilenenidir. Teknolojinin bu kadar yaygınlaşması ve karmaşık hale gelmesi, onu kullanabilecek nitelikte donanımlı insanlar gerektirmektedir. Birçok araştırma göstermektedir ki, hızlı teknolojik gelişmeler karşısında gereken yetenek altyapısı oluşturulamamıştır. Bu yüzden birçok şirket, özellikle teknoloji yoğun pozisyonlarda yetenek açığı çekmektedir. Bu açığı kapatmak için kendi içinde gelişim programları düzenleyen pek çok şirket var. İşin daha dramatik boyutu, bazı meslekler artık kendini tamamen teknolojiye bırakmış durumda ve artık bu meslek alanlarında çalışanların kendilerini başka alanlarda çalışacak şekilde geliştirmesi bir zorunluluk. Tüm bu dönüşüm süreci içinde; yeni dünyayı anlamış, bu dünyada başarılı olabilecek dijital ve teknoloji yetkinliklerine sahip adayların istihdamı kuşkusuz daha kolay. Bu konudaki gelişim ihtiyacı sadece istihdamla ilgili de değil çünkü bu beceriler gündelik yaşamda da çok önemli hale gelmiş durumda. İnterneti iyi kullanan, aradığı tüm bilgilere ulaşabilen, ihtiyacına göre dijital uygulamaları arayıp bulan, siber dünyada güvenliğini koruyabilen tüm bireyler birçok alanda öne çıkıyor. Ayrıca bu dünya fırsatlar dünyasıdır. Yeni mecralar, yeni işler, yeni para kazanma biçimleri ortaya çıkarken bu fırsatları ancak yeterli donanıma sahip bireyler yakalayabilecek. Tüm bu açılardan bakıldığında bu yetkinlik, diğer tüm yetkinliklerin gücünü artırması açısından önemli.";
  static String successExamResultDescription3 = "Bu alanda önerilen eğitimler";
  static String successExamResultDescription3Content =
      "Tobeto ‘İşte Başarı Modeli’nin son yetkinliği yeni dünya ile ilgilidir. Bu yetkinlik, diğer yedi yetkinlikten farklı olarak, yeni dünya ile ilgili farkındalık yaratmak ve herkesin kendisini olabildiğince buna hazırlaması konusunda yönlendirici olması için modele eklenmiştir. Zira içinde bulunduğumuz zamanlar önemli bir geçiş sürecine işaret etmektedir. Dijital teknolojilerle birlikte yaşanan dönüşümler hayatın her alanını yeninden şekillendirmektedir. İş dünyası ve şirketler de bu dönüşümün hem lokomotifi hem de etkilenenidir. Teknolojinin bu kadar yaygınlaşması ve karmaşık hale gelmesi, onu kullanabilecek nitelikte donanımlı insanlar gerektirmektedir. Birçok araştırma göstermektedir ki, hızlı teknolojik gelişmeler karşısında gereken yetenek altyapısı oluşturulamamıştır. Bu yüzden birçok şirket, özellikle teknoloji yoğun pozisyonlarda yetenek açığı çekmektedir. Bu açığı kapatmak için kendi içinde gelişim programları düzenleyen pek çok şirket var. İşin daha dramatik boyutu, bazı meslekler artık kendini tamamen teknolojiye bırakmış durumda ve artık bu meslek alanlarında çalışanların kendilerini başka alanlarda çalışacak şekilde geliştirmesi bir zorunluluk. Tüm bu dönüşüm süreci içinde; yeni dünyayı anlamış, bu dünyada başarılı olabilecek dijital ve teknoloji yetkinliklerine sahip adayların istihdamı kuşkusuz daha kolay. Bu konudaki gelişim ihtiyacı sadece istihdamla ilgili de değil çünkü bu beceriler gündelik yaşamda da çok önemli hale gelmiş durumda. İnterneti iyi kullanan, aradığı tüm bilgilere ulaşabilen, ihtiyacına göre dijital uygulamaları arayıp bulan, siber dünyada güvenliğini koruyabilen tüm bireyler birçok alanda öne çıkıyor. Ayrıca bu dünya fırsatlar dünyasıdır. Yeni mecralar, yeni işler, yeni para kazanma biçimleri ortaya çıkarken bu fırsatları ancak yeterli donanıma sahip bireyler yakalayabilecek. Tüm bu açılardan bakıldığında bu yetkinlik, diğer tüm yetkinliklerin gücünü artırması açısından önemli.";
  // catalog page/main
  ...
  static String calendarEducationSearch = "Eğitim Arama";
  static String calendarEducationSearchBox = "Lütfen eğitim arayınız...";
  static String calendarInstructors = "Eğitmenler";
  static String calendarInstructorsBox = "Lütfen eğitmen seçiniz...";
  static String calendarEducationStatu = "Eğitim Durumu";
  static String calendarEducationBox1 = "Bitmiş Dersler";
  static String calendarEducationBox2 = "Devam Eden Dersler";
  static String calendarEducationBox3 = "Satın Alınmış Dersler";
  ...
  static String istanbulCard3Body1 = "• Online Canlı Dersler\n"
      ...
      "• Proje Uygulamaları";
  static String istanbulCard3Title3 = "Profesyonel Gelişim Eğitimler";
  static String istanbulCard3Body2 = "• İşte Başarı Eğitimleri\n"
  ...
  static String istanbulHeadline7 = "Sikça Sorulan Sorular";
  static String istanbulApplicationButton = "Başvuru ve Ön-değerlendirme";
...
// main page
  ...
  static String tmainButton = "Hemen Başla";
  ...
  static String tmainHeadline3Body =
  ...
  static String tmainHeadline4Name = "Zeynep KOŞUN";
  static String tmainHeadline4Student = "Öğrenci";
  // who are we
  static String twawCard1Body1 = "Yeni Nesil\n";
  static String twawCard1Body11 = "Mesleklere\n";
  ...
  static String tofferPersonalCard1BodyRich1 = "Kontrol sende\n";
  static String tofferPersonalCard1BodyRich2 = "adım at,\n";
  static String tofferPersonalCard1BodyRich3 = "Tobeto ile fark yarat!";
  ...
  static String tofferPersonalCard3Title = "Öğrenme Yolculuğu";
  static String tofferPersonalCard3Body =
      "Deneyim sahibi olmak istediğin alanda “Öğrenme Yolculuğu’na” başla. Yazılım ekipleri ile çalış."
      "• Sektör projeleri\n"
      "• Fasilitatör projeleri\n"
      "• Mentör desteği\n"
      "• Hibrit eğitim modeli";
  static String tofferPersonalCard4Title = "Kariyer Yolculuğu";
  static String tofferPersonalCard4Body =
  ...
  static String tofferPersonalCard5TitleE1 = "AI PROMPTING";
  static String tofferPersonalCard5TitleE2 = "PROJE YÖNETİMİ";
  static String tofferPersonalCard5TitleE3 = "FULL STACK DEVELOPER";
  static String tofferPersonalCard5TitleE4 = "İŞ ANALİSTİ";
  static String tofferPersonalCard5TitleE5 = "DİJİTAL PAZARLAMA";
  static String tofferPersonalCard5TitleE6 = "YAZILIM KALİTE";
// what do we offer/companies
  static String tcompaniesCard1BodyRich1 = 'Tobeto: yetenekleri\n';
  static String tcompaniesCard1BodyRich2 = 'keşfeder,';
  static String tcompaniesCard1BodyRich3 = ' geliştirir\nve yeni işine \nhazırlar.';
  ...
  static String tcompaniesCard4Title = "Bootcamp";
  ...
  static String tcompaniesCard7Title = "Ölçme Araçları";
  static String tcompaniesCard7Body =
  ...
  static String tcompaniesCard8Title = "Eğitim";
  static String tcompaniesCard8Body =
  ...
  static String tcompaniesCard9Title = "Gelişim";
  static String tcompaniesCard9Body =
      "Kurumsal hedefler doğrultusunda mevcut yetenek gücünün gelişimi ve konumlandırılmasına destek.";
  static String tcompaniesCard10Body =
  ...
  static String tblogBody3 =
      "Uygulama Programlama Arayüzü’nün kısaltması olan API, modern yazılım geliştirmenin önemli bir bileşenidir. Farklı yazılım uygulamaları arasında sorunsuz iletişim ve etkileşimi kolaylaştıran bir protokoller, kurallar ve araçlar koleksiyonundan oluşur. Daha basit bir ifadeyle, API'ler geliştiricilerin sıfırdan inşa etmek zorunda kalmadan çeşitli işlevleri ve hizmetleri uygulamalarına entegre etmelerine olanak tanır.";
  static String tblogTitle4 = "API Nasıl Çalışır?";
  static String tblogBody4 =
      "API'ler, bir dizi kural ve yöntem oluşturarak farklı yazılım uygulamaları arasındaki iletişimi kolaylaştırır. Bir geliştirici olarak, belirli özelliklere erişmek veya veri almak için kullanabileceğin bir dizi işlev, sınıf veya prosedür sunan API'lerle karşılaşman muhtemeldir. Bu araç grupları, diğer sistemlerle entegre olmanı ve geliştirme sürecini kolaylaştırmak için tasarlanmıştır.";
  static String tblogSubtitlePreviousButton = "Önceki";
  static String tblogSubtitleNextButton = "Sonraki";
  // press
  ...
  static String tcommunucationSideTitle4 = "Vergi No:";
  static String tcommunucationSideTitle5 = "Telefon:";
  static String tcommunucationSideTitle6 = "E-Posta:";
  static String tcommunucationSideTitle7 = "Adres:";
  ...
  static String tcommunucationComment5 = "0 (216) 331 48 00";
  static String tcommunucationComment6 = "info@tobeto.com";
  static String tcommunucationComment7 =
      "Kavacık, Rüzgarlıbahçe Mah. Çampınarı Sok. No:4 Smart Plaza B Blok Kat:3 34805, Beykoz/İstanbul";
  static String tcommunucationComment8 = "\n0 (216) 969 22 40";
  static String tcommunucationComment9 = "\nistanbulkodluyor@tobeto.com";
  static String tcommunucationMessageButton = "Mesaj Bırakın";
  static String tcommunucationTitle2 = "İletişim Formu";
  static String tcommunucationNameBox = "Adınız Soyadınız";
  static String tcommunucationMailBox = "E-Mail";
  static String tcommunucationMessageBox = "Mesajınız";
  static String tcommunucationSubtitle =
  ...
  static String tcommunucationSendButton = "Gönder";
  // site map and sources
  static String tmapTitle = "Site Haritası";
  static String tmapAboutBox = "Hakkımızda";
  static String tmapPersonBox = "Bireyler İçin";
  static String tmapCompaniesBox = "Kurumlar İçin";
  static String tmapCorporateBox = "Kurumsal Kimlik";
  static String tmapFAQBox = "S.S.S.";
  static String tmapCommunicstionBox = "İletişim";
  static String tsourceTitle = "Kaynaklar";
  static String tsourceMemberBox = "Üyelik Sözleşmesi ve Kullanım Koşulları";
  static String tsourceGDPRBox = "KVKK Aydınlatma Metni";
  ...
  static String hambugerMenuWhatDoWeOffer = "Bireyler için";
  static String hambugerMenuWhatDoWeOfferfor = "Kurumlar İçin";
  ...
  //educator
  static String educatorHomeMain1 = "Tobeto; yetenekleri keşfeder, geliştirir ve yeni işine hazırlar.";
  static String exit = "Çıkış Yap";
  //hata mesajı, eşlemeler, kişiler
  static String tobeto = "tobeto";
  static String bigTobeto = "Tobeto";
  static String education = "education";
  static String bigEducation = "Eğitim";
  static String support = "support";
  static String bigSupport = "Destek";
  static String unKnown = "Bilinmedik Durum!";
  static String elifKilic = "Elif KILIÇ";
  static String kaderYavuz = "Kader YAVUZ";
  static String gurkanIlisen = "Gürkan İLİŞEN";
  static String pelinBatir = "Pelin BATIR";
  static String aliSeyhan = "Ali SEYHAN";
}
